...
|---|---|---|---|---|---|
| 2026-05-08 | high | pipeline | [mega-source-pool-too-narrow](2026-05-08-mega-source-pool-too-narrow.md) | FUN category collapsed to 1 distinct source for two consecutive days — mega path `phase_a_light` called `load_sources(cat)` with default `n=3`, never reaching the cadence-aware sleeping fallback. 21 configured Fun sources, 3 actually loaded. | load_sources, mega, phase_a_light, phase_a_probe, source-diversity, cadence, fallback, auto-pause, probe_drops_thin |
